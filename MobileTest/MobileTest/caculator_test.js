...
const resourceId = (id) => `android=new UiSelector().resourceId("com.example.codeceptjsversion2:id/${id}")`;

// Helper function for result text view
const resultTextView = () => `android=new UiSelector().resourceId("com.example.codeceptjsversion2:id/resultTextView").className("android.widget.TextView")`;

// Alternative locator strategies if needed:
// const resourceId = (id) => `id=com.example.codeceptjsversion2:id/${id}`;
// const resourceId = (id) => `android=new UiSelector().resourceId("com.example.codeceptjsversion2:id/${id}")`;
